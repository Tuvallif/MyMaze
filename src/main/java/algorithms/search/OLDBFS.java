...
// if(boardHelper[curPos.getHeight()][curPos.getWidth()][curPos.getDepth()].getMycolor()
// != Color.BLACK){
// search(curPos);
// }
...
// PositionHelper myStart =
// boardHelper[p.getHeight()][p.getWidth()][p.getDepth()];
//
// visited.add(p);
// for(Position neiPos : myMaze.getNeighborPositions(p)){
// //using the cell itself
// PositionHelper neiPosHelper =
// boardHelper[neiPos.getHeight()][neiPos.getWidth()][neiPos.getDepth()];
//
// //if not a wall
// if(myMaze.getValueAtPosition(neiPos) == 0 && neiPosHelper.getMydistance() >
// myStart.getMydistance() + 1){
...
// }
//
// private void changePositionHelper(PositionHelper toCheck,PositionHelper
// father){
...
// boardHelper = new PositionHelper[myMaze.getHeight()][ myMaze.getWidth()][
// myMaze.getDepth()];
...
// PositionHelper curPosHelper =
// boardHelper[curPos.getHeight()][curPos.getWidth()][curPos.getDepth()];
